...
#' feasibility_community(matA) ## This is the feasibility of the community A with nA=4 species. This measure cannot be compared across communities with different number of species.
#' feasibility_community(matA,raw=FALSE) ## This is the species-specific feasibility of the community A with nA=4 species. This measure can be conmpared across communities with different number of species.
